...
const RequestsCourses = () => {
  const [sidebarCollapsed, setSidebarCollapsed] = useState(false);
  const [courseRequests, setCourseRequests] = useState([
    {
      id: 1,
      title: 'الرياضيات المتقدمة',
      description: 'كورس شامل في الرياضيات المتقدمة للصف الثالث الثانوي',
      requester: 'أحمد محمد',
      date: '2024-01-15',
      votes: 45,
      status: 'pending'
    },
    {
      ...
      description: 'دورة عملية في الفيزياء التطبيقية مع تجارب عملية',
      requester: 'فاطمة علي',
      date: '2024-01-10',
      votes: 67,
      status: 'approved'
    },
    {
      ...
      description: 'شرح مفصل للكيمياء العضوية مع حل تمارين متنوعة',
      requester: 'محمد أحمد',
      date: '2024-01-08',
      votes: 32,
      status: 'in-progress'
  ...
  const handleSubmitRequest = (e) => {
    ...
    if (newRequest.title && newRequest.description) {
      ...
      setCourseRequests([...courseRequests, request]);
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'in-progress':
        return <span className="badge bg-info">قيد التنفيذ</span>;
      case 'completed':
        return <span className="badge bg-secondary">مكتمل</span>;
      default:
        return <span className="badge bg-light">غير محدد</span>;
    }
  };
    ...
    <div>
      ...
      <nav className={`sidebar shadow-sm pt-5 ${sidebarCollapsed ? 'collapsed' : ''}`} id="sidebar">
        <div className="pt-4">
          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item mb-3">
              <Link to="/requests-courses" title="كورساتنا المقترحة" className="nav-link text-dark active">
      ...
      <div className={`main-content ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        <div className="container mt-5 pt-4">
          <h2 className="mb-4 text-center pt-2">كورساتنا المقترحة</h2>
...
export default RequestsCourses;
